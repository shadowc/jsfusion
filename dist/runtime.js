...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"ComponentHandler\": () => (/* binding */ ComponentHandler)\n/* harmony export */ });\n/* harmony import */ var _abstract_handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-handler */ \"./src/handlers/abstract-handler.ts\");\n/* harmony import */ var _helpers_parse_attribute__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/parse-attribute */ \"./src/helpers/parse-attribute.ts\");\n/* harmony import */ var _helpers_get_component_names_from_parsed_attribute__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/get-component-names-from-parsed-attribute */ \"./src/helpers/get-component-names-from-parsed-attribute.ts\");\nvar __extends = (undefined && undefined.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        if (typeof b !== \"function\" && b !== null)\n            throw new TypeError(\"Class extends value \" + String(b) + \" is not a constructor or null\");\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\n\n\n\nvar ComponentHandler = /** @class */ (function (_super) {\n    __extends(ComponentHandler, _super);\n    function ComponentHandler() {\n        return _super !== null && _super.apply(this, arguments) || this;\n    }\n    ComponentHandler.prototype.handleAttribute = function (attribute, element) {\n        var _this = this;\n        var componentNames = (0,_helpers_get_component_names_from_parsed_attribute__WEBPACK_IMPORTED_MODULE_2__.getComponentNamesFromParsedAttribute)((0,_helpers_parse_attribute__WEBPACK_IMPORTED_MODULE_1__.parseAttribute)(element, attribute));\n        componentNames.forEach(function (component) {\n            _this.parent.registerComponentElement(component, element);\n        });\n    };\n    return ComponentHandler;\n}(_abstract_handler__WEBPACK_IMPORTED_MODULE_0__.AbstractHandler));\n\n\n\n//# sourceURL=webpack://jsfusion/./src/handlers/component-handler.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"PropsHandler\": () => (/* binding */ PropsHandler)\n/* harmony export */ });\n/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../logger */ \"./src/logger.ts\");\n/* harmony import */ var _abstract_handler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./abstract-handler */ \"./src/handlers/abstract-handler.ts\");\n/* harmony import */ var _helpers_parse_attribute__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/parse-attribute */ \"./src/helpers/parse-attribute.ts\");\n/* harmony import */ var _helpers_get_component_names_from_parsed_attribute__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/get-component-names-from-parsed-attribute */ \"./src/helpers/get-component-names-from-parsed-attribute.ts\");\n/* harmony import */ var _helpers_get_components_from_element__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers/get-components-from-element */ \"./src/helpers/get-components-from-element.ts\");\nvar __extends = (undefined && undefined.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        if (typeof b !== \"function\" && b !== null)\n            throw new TypeError(\"Class extends value \" + String(b) + \" is not a constructor or null\");\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\n\n\n\n\n\nvar PropsHandler = /** @class */ (function (_super) {\n    __extends(PropsHandler, _super);\n    function PropsHandler() {\n        return _super !== null && _super.apply(this, arguments) || this;\n    }\n    PropsHandler.prototype.handleAttribute = function (attribute, element) {\n        var _a;\n        var attrValue = (0,_helpers_parse_attribute__WEBPACK_IMPORTED_MODULE_2__.parseAttribute)(element, attribute);\n        _logger__WEBPACK_IMPORTED_MODULE_0__.Logger.log(\"Attempting to add props to a component for \".concat(attribute, \".\"), element, attrValue);\n        if (!element.hasAttribute('data-component')) {\n            _logger__WEBPACK_IMPORTED_MODULE_0__.Logger.error('Error: Prop attributes must be declared in the same element that defines the component.');\n            throw 'data-props attribute doesn\\'t belong to a component element';\n        }\n        if (Array.isArray(attrValue)) {\n            _logger__WEBPACK_IMPORTED_MODULE_0__.Logger.error('Prop attributes has to be of type Object. It was parsed as an Array.', attrValue);\n            throw 'Syntax error data-props.';\n        }\n        // Get component names defined in the element\n        var componentNames = (0,_helpers_get_component_names_from_parsed_attribute__WEBPACK_IMPORTED_MODULE_3__.getComponentNamesFromParsedAttribute)((0,_helpers_parse_attribute__WEBPACK_IMPORTED_MODULE_2__.parseAttribute)(element, 'data-component'));\n        // Assert that only one component is present or the components are correctly identified in the object keys\n        if (componentNames.length > 1) {\n            Object.keys(attrValue).forEach(function (propKey) {\n                if (componentNames.indexOf(propKey) === -1) {\n                    _logger__WEBPACK_IMPORTED_MODULE_0__.Logger.error('Error: Prop attributes must be declared in the same element that defines the component. Elements with multiple components must have props defined for each of its components.');\n                    throw 'data-props attribute doesn\\'t belong to a component element.';\n                }\n            });\n        }\n        // Parse component props according to propTypes\n        var localRegistry = (0,_helpers_get_components_from_element__WEBPACK_IMPORTED_MODULE_4__.getComponentsFromElement)(element, this.parent.componentRegistry);\n        var componentProps = localRegistry.length === 1 ? (_a = {}, _a[localRegistry[0].name] = attrValue, _a) : attrValue;\n        localRegistry.forEach(function (compRecord) {\n            var compProps = componentProps[compRecord.name];\n            Object.keys(compProps).forEach(function (propName) {\n                var propType = compRecord.component.propTypes[propName];\n                if (typeof propType === 'undefined') {\n                    return;\n                }\n                if ((propType.type === String && typeof compProps[propName] === 'string')\n                    || (propType.type === Boolean && typeof compProps[propName] === 'boolean')\n                    || (propType.type === Number && typeof compProps[propName] === 'number')\n                    || (propType.type === Array && Array.isArray(compProps[propName]))\n                    || (propType.type instanceof Object && compProps[propName] instanceof Object)) {\n                    compRecord.component.createProp(propName, compProps[propName]);\n                }\n                else {\n                    _logger__WEBPACK_IMPORTED_MODULE_0__.Logger.error(\"Invalid prop type for \".concat(propName, \".\"), propType, compProps[propName]);\n                    throw 'Invalid prop-type.';\n                }\n            });\n            Object.keys(compRecord.component.propTypes).forEach(function (propName) {\n                if (compRecord.component.propTypes[propName].required === true\n                    && typeof compRecord.component.props[propName] === 'undefined') {\n                    _logger__WEBPACK_IMPORTED_MODULE_0__.Logger.error(\"The prop \".concat(propName, \" is required but hasn't been defined! Consider adding a default value.\"));\n                    throw 'Required prop not defined.';\n                }\n            });\n        });\n    };\n    return PropsHandler;\n}(_abstract_handler__WEBPACK_IMPORTED_MODULE_1__.AbstractHandler));\n\n\n\n//# sourceURL=webpack://jsfusion/./src/handlers/props-handler.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getChildrenComponentsFromTree\": () => (/* binding */ getChildrenComponentsFromTree)\n/* harmony export */ });\n/* harmony import */ var _get_components_from_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./get-components-from-element */ \"./src/helpers/get-components-from-element.ts\");\n\nvar getChildrenComponentsFromTree = function (nodes, componentRegistry) {\n    var components = [];\n    nodes.forEach(function (node) {\n        if (node instanceof Element) {\n            var localRegistry = (0,_get_components_from_element__WEBPACK_IMPORTED_MODULE_0__.getComponentsFromElement)(node, componentRegistry);\n            if (localRegistry.length > 0) {\n                localRegistry.forEach(function (compRecord) {\n                    components.push(compRecord.component);\n                });\n            }\n            else if (node.childNodes.length) {\n                var subComponents = getChildrenComponentsFromTree(node.childNodes, componentRegistry);\n                subComponents.forEach(function (subComponent) {\n                    components.push(subComponent);\n                });\n            }\n        }\n    });\n    return components;\n};\n\n\n//# sourceURL=webpack://jsfusion/./src/helpers/get-children-components-from-tree.ts?");

/***/ }),

/***/ "./src/helpers/get-component-names-from-parsed-attribute.ts":
/*!******************************************************************!*\
  !*** ./src/helpers/get-component-names-from-parsed-attribute.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getComponentNamesFromParsedAttribute\": () => (/* binding */ getComponentNamesFromParsedAttribute)\n/* harmony export */ });\n/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../logger */ \"./src/logger.ts\");\n\n/**\n * Gets a parsed attribute and returns a list of component names, given that the attribute value comes\n * from data-component.\n *\n * Throws an error if the information parsed is not valid\n */\nvar getComponentNamesFromParsedAttribute = function (parsedAttribute) {\n    if (!Array.isArray(parsedAttribute)) {\n        _logger__WEBPACK_IMPORTED_MODULE_0__.Logger.error('Invalid data when trying to parse data-component attribute', parsedAttribute);\n        throw 'Syntax error data-component.';\n    }\n    parsedAttribute.forEach(function (word) {\n        if (typeof word !== 'string') {\n            _logger__WEBPACK_IMPORTED_MODULE_0__.Logger.error('Invalid data when trying to parse data-component attribute', parsedAttribute);\n            throw 'Syntax error data-component.';\n        }\n    });\n    return parsedAttribute;\n};\n\n\n//# sourceURL=webpack://jsfusion/./src/helpers/get-component-names-from-parsed-attribute.ts?");

/***/ }),

/***/ "./src/helpers/get-components-from-element.ts":
/*!****************************************************!*\
  !*** ./src/helpers/get-components-from-element.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getComponentsFromElement\": () => (/* binding */ getComponentsFromElement)\n/* harmony export */ });\nvar getComponentsFromElement = function (element, componentRegistry) {\n    var localRegistry = [];\n    componentRegistry.forEach(function (compRecord) {\n        if (compRecord.node === element) {\n            localRegistry.push({\n                name: compRecord.name,\n                component: compRecord.component,\n                node: element,\n            });\n        }\n    });\n    return localRegistry;\n};\n\n\n//# sourceURL=webpack://jsfusion/./src/helpers/get-components-from-element.ts?");

/***/ }),

/***/ "./src/helpers/parse-attribute.ts":
/*!****************************************!*\
  !*** ./src/helpers/parse-attribute.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"parseAttribute\": () => (/* binding */ parseAttribute)\n/* harmony export */ });\n/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../logger */ \"./src/logger.ts\");\n\n/**\n * Returns the result of JSON parse or an array of strings representing the different words in an attribute\n */\nvar parseAttribute = function (element, attribute) {\n    var attrValue = element.getAttribute(attribute).trim();\n    _logger__WEBPACK_IMPORTED_MODULE_0__.Logger.log(\"Parsing attribute \".concat(attribute, \" for value \\\"\").concat(attrValue, \"\\\"\"));\n    try {\n        return JSON.parse(attrValue);\n    }\n    catch (e) {\n        return attrValue.split(' ');\n    }\n};\n\n\n//# sourceURL=webpack://jsfusion/./src/helpers/parse-attribute.ts?");
